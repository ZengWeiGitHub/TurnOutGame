...
public class tk2dUITextInput : MonoBehaviour
{
    ...
    private void FormatTextForDisplay(string modifiedText)
    {
		...
		if(inputLabel2 != null)
		{
			inputLabel2.text = modifiedText;
			inputLabel2.RefreshMesh (true);
		}
...
#endif
			keyboard = TouchScreenKeyboard.Open(text, keyboardType, false, false, false, false);
