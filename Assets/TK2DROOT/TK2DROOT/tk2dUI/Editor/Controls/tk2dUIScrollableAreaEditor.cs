...
public class tk2dUIScrollableAreaEditor : Editor
{
    ...
    public void OnSceneGUI()
    {
        ...
        float newVisibleAreaLength = tk2dUIControlsHelperEditor.DrawLengthHandles("Visible Area Length", scrollableArea.VisibleAreaLength,scrollableArea.contentContainer.transform.position, isYAxis? -up:right, Color.red,isYAxis?0.2f:-0.2f, 0, .05f);
